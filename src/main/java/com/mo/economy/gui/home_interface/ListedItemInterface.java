...
public class ListedItemInterface {
    // 创建一个九格的物品栏
    private final SimpleInventory show_inventory = new SimpleInventory(9);

    // 玩家市场面板
    private WPlainPanel listedItemPane;
    // 搜索框
    ...
    // 商品购买按钮1
    private WButton DISCONTINUED_BUTTON_1;
    // 商品面板2
    ...
    // 商品购买按钮2
    private WButton DISCONTINUED_BUTTON_2;
    // 商品面板3
    ...
    // 商品购买按钮3
    private WButton DISCONTINUED_BUTTON_3;
    // 商品面板4
    ...
    // 商品购买按钮4
    private WButton DISCONTINUED_BUTTON_4;
    // 商品面板5
    ...
    // 商品购买按钮5
    private WButton DISCONTINUED_BUTTON_5;
    // 商品面板6
    ...
    // 商品购买按钮6
    private WButton DISCONTINUED_BUTTON_6;
    // 商品面板7
    ...
    // 商品购买按钮7
    private WButton DISCONTINUED_BUTTON_7;
    // 商品面板8
    ...
    // 商品购买按钮8
    private WButton DISCONTINUED_BUTTON_8;
    // 商品面板9
    ...
    // 商品购买按钮9
    private WButton DISCONTINUED_BUTTON_9;
    // 商品面板组
    ...
    // 商品购买按钮组
    private WButton[] DISCONTINUED_BUTTONS;
    // 上一页按钮
    ...
    public ListedItemInterface() {
        listedItemPane = new WPlainPanel();
        listedItemPane.setSize(500, 300);  // 设置面板大小
        ...
        listedItemPane.add(searchField, SEARCH_FIELD_X, SEARCH_FIELD_Y);
        ...
        listedItemPane.add(searchButton, SEARCH_BUTTON_X, SEARCH_BUTTON_Y);
        ...
        // 添加一个"购买"按钮
        DISCONTINUED_BUTTON_1 = new WButton(Text.translatable("gui.home_interface.discontinued_button")) {
            @Override
            public void paint(DrawContext context, int x, int y, int mouseX, int mouseY) {
                super.paint(context, x, y, mouseX, mouseY);  // 确保调用父类的绘制方法
                this.setSize(70, 20);  // 强制按钮大小为100x20
        ...
        DISCONTINUED_BUTTON_1.setOnClick(() -> {
            System.out.println("1");
        });
        itemPane1.add(DISCONTINUED_BUTTON_1, itemPane1.getWidth() - 90, 0);  // 将buyButton放置在(220, 0)位置
        // 将itemPanel添加到主面板或其他容器中
        listedItemPane.add(itemPane1, 0, ITEM_PANE_1_Y);
        ...
        // 添加一个"购买"按钮
        DISCONTINUED_BUTTON_2 = new WButton(Text.translatable("gui.home_interface.discontinued_button")) {
            @Override
            public void paint(DrawContext context, int x, int y, int mouseX, int mouseY) {
                super.paint(context, x, y, mouseX, mouseY);  // 确保调用父类的绘制方法
                this.setSize(70, 20);  // 强制按钮大小为100x20
        ...
        itemPane2.add(DISCONTINUED_BUTTON_2, itemPane2.getWidth() - 90, 0);  // 将buyButton放置在(220, 0)位置
        // 将itemPanel添加到主面板或其他容器中
        listedItemPane.add(itemPane2, 0, ITEM_PANE_2_Y);
        ...
        // 添加一个"购买"按钮
        DISCONTINUED_BUTTON_3 = new WButton(Text.translatable("gui.home_interface.discontinued_button")) {
            @Override
            public void paint(DrawContext context, int x, int y, int mouseX, int mouseY) {
                super.paint(context, x, y, mouseX, mouseY);  // 确保调用父类的绘制方法
                this.setSize(70, 20);  // 强制按钮大小为100x20
        ...
        itemPane3.add(DISCONTINUED_BUTTON_3, itemPane3.getWidth() - 90, 0);  // 将buyButton放置在(220, 0)位置
        // 将itemPanel添加到主面板或其他容器中
        listedItemPane.add(itemPane3, 0, ITEM_PANE_3_Y);
        ...
        // 添加一个"购买"按钮
        DISCONTINUED_BUTTON_4 = new WButton(Text.translatable("gui.home_interface.discontinued_button")) {
            @Override
            public void paint(DrawContext context, int x, int y, int mouseX, int mouseY) {
                super.paint(context, x, y, mouseX, mouseY);  // 确保调用父类的绘制方法
                this.setSize(70, 20);  // 强制按钮大小为100x20
        ...
        itemPane4.add(DISCONTINUED_BUTTON_4, itemPane4.getWidth() - 90, 0);  // 将buyButton放置在(220, 0)位置
        // 将itemPanel添加到主面板或其他容器中
        listedItemPane.add(itemPane4, 0, ITEM_PANE_4_Y);
        ...
        // 添加一个"购买"按钮
        DISCONTINUED_BUTTON_5 = new WButton(Text.translatable("gui.home_interface.discontinued_button")) {
            @Override
            public void paint(DrawContext context, int x, int y, int mouseX, int mouseY) {
                super.paint(context, x, y, mouseX, mouseY);  // 确保调用父类的绘制方法
                this.setSize(70, 20);  // 强制按钮大小为100x20
        ...
        itemPane5.add(DISCONTINUED_BUTTON_5, itemPane5.getWidth() - 90, 0);  // 将buyButton放置在(220, 0)位置
        // 将itemPanel添加到主面板或其他容器中
        listedItemPane.add(itemPane5, 0, ITEM_PANE_5_Y);
        ...
        // 添加一个"购买"按钮
        DISCONTINUED_BUTTON_6 = new WButton(Text.translatable("gui.home_interface.discontinued_button")) {
            @Override
            public void paint(DrawContext context, int x, int y, int mouseX, int mouseY) {
                super.paint(context, x, y, mouseX, mouseY);  // 确保调用父类的绘制方法
                this.setSize(70, 20);  // 强制按钮大小为100x20
        ...
        itemPane6.add(DISCONTINUED_BUTTON_6, itemPane6.getWidth() - 90, 0);  // 将buyButton放置在(220, 0)位置
        // 将itemPanel添加到主面板或其他容器中
        listedItemPane.add(itemPane6, 0, ITEM_PANE_6_Y);
        ...
        // 添加一个"购买"按钮
        DISCONTINUED_BUTTON_7 = new WButton(Text.translatable("gui.home_interface.discontinued_button")) {
            @Override
            public void paint(DrawContext context, int x, int y, int mouseX, int mouseY) {
                super.paint(context, x, y, mouseX, mouseY);  // 确保调用父类的绘制方法
                this.setSize(70, 20);  // 强制按钮大小为100x20
        ...
        itemPane7.add(DISCONTINUED_BUTTON_7, itemPane7.getWidth() - 90, 0);  // 将buyButton放置在(220, 0)位置
        // 将itemPanel添加到主面板或其他容器中
        listedItemPane.add(itemPane7, 0, ITEM_PANE_7_Y);
        ...
        // 添加一个"购买"按钮
        DISCONTINUED_BUTTON_8 = new WButton(Text.translatable("gui.home_interface.discontinued_button")) {
            @Override
            public void paint(DrawContext context, int x, int y, int mouseX, int mouseY) {
                super.paint(context, x, y, mouseX, mouseY);  // 确保调用父类的绘制方法
                this.setSize(70, 20);  // 强制按钮大小为100x20
        ...
        itemPane8.add(DISCONTINUED_BUTTON_8, itemPane8.getWidth() - 90, 0);  // 将buyButton放置在(220, 0)位置
        // 将itemPanel添加到主面板或其他容器中
        listedItemPane.add(itemPane8, 0, ITEM_PANE_8_Y);
        ...
        // 添加一个"购买"按钮
        DISCONTINUED_BUTTON_9 = new WButton(Text.translatable("gui.home_interface.discontinued_button")) {
            @Override
            public void paint(DrawContext context, int x, int y, int mouseX, int mouseY) {
                super.paint(context, x, y, mouseX, mouseY);  // 确保调用父类的绘制方法
                this.setSize(70, 20);  // 强制按钮大小为100x20
        ...
        itemPane9.add(DISCONTINUED_BUTTON_9, itemPane9.getWidth() - 90, 0);  // 将buyButton放置在(220, 0)位置
        // 将itemPanel添加到主面板或其他容器中
        listedItemPane.add(itemPane9, 0, ITEM_PANE_9_Y);
        ...
        DISCONTINUED_BUTTONS = new WButton[]{DISCONTINUED_BUTTON_1, DISCONTINUED_BUTTON_2, DISCONTINUED_BUTTON_3, DISCONTINUED_BUTTON_4, DISCONTINUED_BUTTON_5, DISCONTINUED_BUTTON_6, DISCONTINUED_BUTTON_7, DISCONTINUED_BUTTON_8, DISCONTINUED_BUTTON_9};
        ...
        listedItemPane.add(previousPageButton, 20, listedItemPane.getHeight() - 30);
        ...
        listedItemPane.add(nextPageButton, listedItemPane.getWidth() - 40, listedItemPane.getHeight() - 30);
    }
    ...
    public WPlainPanel getListedItemPane() {
        return listedItemPane;
    }

    public void setListedItemPane(WPlainPanel listedItemPane) {
        this.listedItemPane = listedItemPane;
    }
    ...
    public WButton getDISCONTINUED_BUTTON_1() {
        return DISCONTINUED_BUTTON_1;
    }

    public void setDISCONTINUED_BUTTON_1(WButton DISCONTINUED_BUTTON_1) {
        this.DISCONTINUED_BUTTON_1 = DISCONTINUED_BUTTON_1;
    }
    ...
    public WButton getDISCONTINUED_BUTTON_2() {
        return DISCONTINUED_BUTTON_2;
    }

    public void setDISCONTINUED_BUTTON_2(WButton DISCONTINUED_BUTTON_2) {
        this.DISCONTINUED_BUTTON_2 = DISCONTINUED_BUTTON_2;
    }
    ...
    public WButton getDISCONTINUED_BUTTON_3() {
        return DISCONTINUED_BUTTON_3;
    }

    public void setDISCONTINUED_BUTTON_3(WButton DISCONTINUED_BUTTON_3) {
        this.DISCONTINUED_BUTTON_3 = DISCONTINUED_BUTTON_3;
    }
    ...
    public WButton getDISCONTINUED_BUTTON_4() {
        return DISCONTINUED_BUTTON_4;
    }

    public void setDISCONTINUED_BUTTON_4(WButton DISCONTINUED_BUTTON_4) {
        this.DISCONTINUED_BUTTON_4 = DISCONTINUED_BUTTON_4;
    }
    ...
    public WButton getDISCONTINUED_BUTTON_5() {
        return DISCONTINUED_BUTTON_5;
    }

    public void setDISCONTINUED_BUTTON_5(WButton DISCONTINUED_BUTTON_5) {
        this.DISCONTINUED_BUTTON_5 = DISCONTINUED_BUTTON_5;
    }
    ...
    public WButton getDISCONTINUED_BUTTON_6() {
        return DISCONTINUED_BUTTON_6;
    }

    public void setDISCONTINUED_BUTTON_6(WButton DISCONTINUED_BUTTON_6) {
        this.DISCONTINUED_BUTTON_6 = DISCONTINUED_BUTTON_6;
    }
    ...
    public WButton getDISCONTINUED_BUTTON_7() {
        return DISCONTINUED_BUTTON_7;
    }

    public void setDISCONTINUED_BUTTON_7(WButton DISCONTINUED_BUTTON_7) {
        this.DISCONTINUED_BUTTON_7 = DISCONTINUED_BUTTON_7;
    }
    ...
    public WButton getDISCONTINUED_BUTTON_8() {
        return DISCONTINUED_BUTTON_8;
    }

    public void setDISCONTINUED_BUTTON_8(WButton DISCONTINUED_BUTTON_8) {
        this.DISCONTINUED_BUTTON_8 = DISCONTINUED_BUTTON_8;
    }
    ...
    public WButton getDISCONTINUED_BUTTON_9() {
        return DISCONTINUED_BUTTON_9;
    }

    public void setDISCONTINUED_BUTTON_9(WButton DISCONTINUED_BUTTON_9) {
        this.DISCONTINUED_BUTTON_9 = DISCONTINUED_BUTTON_9;
    }
    ...
    public WButton[] getDISCONTINUED_BUTTONS() {
        return DISCONTINUED_BUTTONS;
    }

    public void setDISCONTINUED_BUTTONS(WButton[] DISCONTINUED_BUTTONS) {
        this.DISCONTINUED_BUTTONS = DISCONTINUED_BUTTONS;
    }
